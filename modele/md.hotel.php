    ...
    class ModeleHotel{
        ...
        public function createHotel(Hotel $hotel){
            ...
            */
            ...
            public function findAll(?int $etoile = null, ?int $chambres = null, string $etoileOp = '>=', string $chambresOp = '>=')
            {
                ...
                if ($etoileOp !== '<=') $etoileOp = '>=';
                if ($chambresOp !== '<=') $chambresOp = '>=';

                if ($etoile !== null) {
                    $sql .= " AND etoile " . $etoileOp . " :etoile";
                    $params[':etoile'] = $etoile;
                }

                if ($chambres !== null) {
                    $sql .= " AND chambre_disponible " . $chambresOp . " :chambres";
